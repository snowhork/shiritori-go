...
func handleHTTPServer(ctx context.Context, u *url.URL, shiritoriEndpoints *shiritori.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
	...
	// Configure the mux.
	shiritorisvr.Mount(mux, shiritoriServer)
	...
	for _, m := range shiritoriServer.Mounts {
